...
public class AuthenticationTest
{
    ...
    public AuthenticationTest(ITestOutputHelper testOutputHelper)
    {
        ...
        _service = new AuthenticationService(_mockRepo.Object, _validator);
    }
    ...
    public void ValidAuthenticationServiceTest()
    {
        // Arrange
        // Act
        IAuthenticationService authService = new AuthenticationService(_mockRepo.Object, _validator);
    ...
    public void InvalidRepositoryAuthenticationServiceTest()
    {
        ...
        var ex = Assert.Throws<NullReferenceException>(() =>
            authService = new AuthenticationService(null, _validator));
    ...
    {
        // Arrange
        RegisterUserDto fakeUser = new RegisterUserDto()
            { Email = "jan@easv.dk", Password = "jan12345", Name = "John Doe" };
    ...
    public void ValidRegisterTest()
    {
        ...
        var fakeUser = new RegisterUserDto() { Email = email, Password = password, Name = name };
        _mockRepo.Setup(UserRepository => UserRepository.GetUserByEmail(fakeUser.Email))
