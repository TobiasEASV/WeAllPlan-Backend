...
public class EventSlotTest
{
    ...
    public void ValidUpdateEventSlotTest()
    {
        ...
        eventSlotDto.StartTime = NewDate.Today();
        eventSlotDto.EndTime = NewDate.Today().AddDays(20);
    ...
    public void InvalidUpdateEventSlotTest()
    {
        ...
        EventSlotDTO eventSlotDto = validEventSlotDTOs[0];
        eventSlotDto.StartTime = NewDate.Today();
        eventSlotDto.EndTime = NewDate.Today().AddDays(-5); //Error

        EventSlotDTO eventSlotDto1 = validEventSlotDTOs[0];
        eventSlotDto1.StartTime = NewDate.Today(); //Error
        eventSlotDto1.EndTime = NewDate.Today().AddDays(-5);
    ...
    private List<EventSlot> validEventSlot = new List<EventSlot>()
    {
        new EventSlot()
        {
            ...
            Event = eventIdOne,
            Id = 1,
            EndTime = NewDate.Today().AddDays(2),
            SlotAnswers = new List<SlotAnswer>()
            {
                new SlotAnswer()
                {
